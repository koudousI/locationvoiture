...
if (isset ($_POST['submit'])) {
		...
		$req = $bdd->prepare('INSERT INTO tuser VALUES(:login,:pass)');
...
<head>
	...
	<title>Location Voiture|Voiture  </title>
	...
	<div class="navbar navbar-inverse navbar-fixed-top headroom" >
		...
		<div class="container">
			...
			<div class="navbar-header">
				...
				<a style="margin-left:25%; width:100%" class="navbar-brand" href="index.php">Car Express</a> <img style="margin-top:-15%" src="assets/images/logg.jpg" alt="" width="40" height="40"></div>
			...
			<div class="navbar-collapse collapse">
				...
				<ul class="nav navbar-nav pull-right">
                    ...
                    <li class="active"><a href="insert_admin.php">inscription admin</a></li>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							...
							<h3 class="thin text-center">Enregistrer un administrateur</h3>
							...
							<form method="post" action="insert_admin.php" >
								...
								<div class="top-margin">
									...
									<label style="margin-top:1.5%	">Login : </label>

									 <input type="text" name = "login"class="form-control" autocomplete="off" required >
