...
if (isset ($_POST['submit'])) {
        ...
        $id= htmlspecialchars($_POST['idmodele']);
   
		$req = $bdd->prepare('INSERT INTO tmodele(idmodele,libelle) VALUES(:idmodele,:libelle)');
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li class="active"><a href="modele.php">Modèles de Voitures</a></li>
				...
				<div class="col-md-6 col-md-offset-3 col-sm-8 col-sm-offset-2">
					<div class="panel panel-default">
						<div class="panel-body">
							<h3 class="thin text-center">Ajout d'un nouveau modèle de voiture </h3>
							
							<hr>
							
							<form method="post" action="insert_modele.php">

								<div class="top-margin">
									<label style="margin-top:1.5%	"> id Modele : <span class="text-danger">*</span></label>
									<input type="text" name="idmodele" class="form-control" autocomplete="off" required>
								</div>

								<div class="top-margin">
									<label style="margin-top:1.5%	"> Libelle : <span class="text-danger">*</span></label>
									<input type="text" name="modele" class="form-control" autocomplete="off" required>
								</div>
