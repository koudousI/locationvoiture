   ...
   
{
	...
	$req= $bdd->query("Select * from tuser where login = '$login' and pass = '$password'"
					);
			$count =$req->rowCount ();
			if ($count==1) 
		...
		<div class="container">
			...
			<div class="navbar-collapse collapse">
				<ul class="nav navbar-nav pull-right">
					...
					<li><a href="e_inscription.php">Inscription / Connexion</a></li>
						<li  class="active" ><a href="back_office.php">Espace administrateur </a></li>
